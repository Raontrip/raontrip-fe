...
import 'package:raon_trip/eng_info.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class EngPage4 extends StatelessWidget {
  int page;
  final int lang;
  final String keyword;
  final String mobileOS;

  EngPage4(this.page, this.lang, this.keyword, this.mobileOS, {super.key});
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('$keyword Search Results'),
          ...
          return GestureDetector(
            onTap: () {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => EngInfoPage(place['title'], place['contentId'], 1, 'ETC'), // DetailPage는 상세 페이지의 위젯입니다.
                ),
              );
            },
